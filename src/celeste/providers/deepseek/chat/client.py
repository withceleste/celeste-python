...
class DeepSeekChatClient(APIMixin):
    ...
    Usage:
        class DeepSeekTextGenerationClient(DeepSeekChatClient, TextGenerationClient):
    ...
    async def _make_request(
        ...
        **parameters: Any,
        ...
        """Make HTTP request to DeepSeek Chat API endpoint."""
        if endpoint is None:
            endpoint = config.DeepSeekChatEndpoint.CREATE_CHAT
    ...
    def _make_stream_request(
        ...
        **parameters: Any,
        ...
        """Make streaming request to DeepSeek Chat API endpoint."""
        if endpoint is None:
            endpoint = config.DeepSeekChatEndpoint.CREATE_CHAT
