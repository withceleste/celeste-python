"""Integration tests for Cohere text generation."""
...
@pytest.mark.asyncio
async def test_cohere_generate(cohere_client: TextGenerationClient) -> None:
    """Test Cohere text generation with max_tokens parameter."""
    # Arrange
    prompt = "Hi"
    ...
    # Cohere may not always return usage metrics in non-streaming mode, so be lenient
