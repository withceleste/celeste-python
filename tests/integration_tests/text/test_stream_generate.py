"""Integration tests for streaming text generation - all registered models."""
...
@pytest.mark.asyncio
async def test_stream_generate(model: Model) -> None:
    """Test streaming text generation for all streaming-capable models.

    Dynamically discovers all streaming models and verifies each can stream text.
